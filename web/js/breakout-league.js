/* Breakout — league table page logic.
   Loads all instrument bars in parallel, computes per-instrument breakout
   stats from the same shared settings, renders a sortable comparison table.
   Re-uses the strategy-engine so numbers match the single-instrument page.
   The d1/d2/d3 stat slots map to the 1 / 5 / 10 day horizons; this table
