/* Multi-Day Move — league table page logic.
   Loads all instrument bars in parallel, computes per-instrument multi-day
   move stats from the same shared settings, renders a sortable comparison
   table. Re-uses the strategy-engine so numbers match the single-instrument
   page. The d1/d2/d3 stat slots map to the 1 / 5 / 10 day horizons; this table
   surfaces the day-1 and day-10 columns. */
